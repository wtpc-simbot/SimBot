...
class Ambiente():
    ...
    def __init__(self, entrada, salida, tamano_x, tamano_y, robot, 
        ...
        ----------
        entrada : 2-tupla
            Posicion de la entrada al laberinto.
        salida : 2-tupla
            Posicion de la salida del laberinto.
        tamano_x : int
            Ancho del laberinto
        tamano_y : int
            Largo del laberinto
        robot : Robot
            El robot que se movera en este laberinto
        cual_ambiente : int
            Un selector de laberintos predefinidos

        Attributes
        ----------
        matriz : np.array de de tamano_x por tamano_y con el siguiente codigo
            0 vacio
    ...
    def estoy_fuera(self):
        ...
        if self.robot.posicion[0] == self.salida[0] and self.robot.posicion[1] == self.salida[1]:
            print "Libertad!!!"
            return True
        else:
            return False
